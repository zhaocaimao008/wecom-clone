  ...
  apps: [
    {
      ...
      env: {
        ...
        VAPID_PUBLIC_KEY:  env.VAPID_PUBLIC_KEY  || process.env.VAPID_PUBLIC_KEY,
        VAPID_PRIVATE_KEY: env.VAPID_PRIVATE_KEY || process.env.VAPID_PRIVATE_KEY,
        VAPID_EMAIL:       env.VAPID_EMAIL       || process.env.VAPID_EMAIL,
      },
      watch: false,
      restart_delay: 1000,
    },
